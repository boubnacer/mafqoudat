...
export const translations = {
  en: {
    ...
    /* ---------------------------------------------------------------
     * Admin panel. Every string the console renders lives here, in all
     * three languages - the panel used to hardcode its table headers, its
     * maintenance controls and its status words in English, which meant an
     * Arabic admin read an Arabic navbar above an English table.
     * ------------------------------------------------------------- */
    processedBy: "Handled by",
    ...
    adminNavOverviewDescription: "What needs attention right now, and how the site is doing.",
    adminNavModeration: "Moderation",
    adminNavModerationDescription: "Reports on listings and comments, and the comment threads themselves.",
    adminNavPosts: "Listings",
    adminNavPostsDescription: "Every lost and found listing on the site.",
    adminNavUsers: "Members",
    adminNavUsersDescription: "Accounts, roles and access.",
    adminNavPromotions: "Promotions",
    adminNavPromotionsDescription: "Listings whose owner asked to have them promoted.",
    adminNavSupport: "Support",
    adminNavSupportDescription: "Messages from the contact form, and password reset requests.",
    adminNavAnalytics: "Analytics",
    adminNavAnalyticsDescription: "Visitors, listings and members over a period you choose.",
    adminNavPlaces: "Places",
    adminNavPlacesDescription: "The cities behind every country the site covers.",
    adminNavSystem: "System",
    adminNavSystemDescription: "Maintenance mode, database health and the admin activity log.",
    needsAttention: "Needs attention",
    needsAttentionBody: "Queues waiting on a decision.",
    queuesClearTitle: "Everything is cleared",
    queuesClearBody: "No reports, promotion requests or support messages are waiting.",
    ...
    lostVsFound: "Lost vs found",
    listingStatusBreakdown: "Listing status",
    newListingsPerDay: "New listings per day",
    newListingsPerDayHint: "Lost and found listings created each day.",
    signupsPerDay: "Sign-ups per day",
    visitorsPerDay: "Visitors per day",
    itemsReturnedPerDay: "Items returned per day",
    itemsReturnedPerDayHint: "Listings marked resolved on each day.",
    itemsReturned: "Items returned",
    listingsWithPhoto: "With a photo",
    siteComments: "Comments",
    visitorsToday: "Visitors today",
    visitors: "Visitors",
    newListings: "New listings",
    newMembers: "New members",
    listingViewsTotal: "Listing views",
    sessionsAllTime: "{count} all time",
    shareOfAllListings: "{value}% of listings",
    ...
    rangeDays: "{days} days",
    allTime: "All time",
    whereVisitorsCameFrom: "Where visitors came from",
    visitorGeographyHint: "Resolved from the visit itself; sessions we could not place are left out.",
    countries: "Countries",
    cities: "Cities",
    ...
    commentUnavailable: "This comment is no longer available",
    byUser: "by {name}",
    details: "Details",
    review: "Review",
    reportUpdated: "Report updated",
    noPendingReports: "No reports waiting",
    noPendingReportsBody: "Everything reported has been judged.",
    ...
    removeCommentTitle: "Remove this comment?",
    removeCommentBody: "It stops being visible on the listing. The text is kept so a report about it can still be judged, and you can restore it later.",
    ...
    searchPostsAdmin: "Search descriptions and locations…",
    allCountries: "All countries",
    noPostsFoundFiltered: "Nothing matches these filters.",
    suspendListing: "Suspend",
    restoreListing: "Restore",
    listingSuspended: "Listing suspended",
    listingRestored: "Listing restored",
    listingStatusUpdated: "Listing marked {status}",
    markAs: "Mark as {status}",
    deleteListingTitle: "Delete this listing?",
    deleteListingBody: "Its photo, comments and any report about it go with it. Suspending takes it off the site without losing any of that.",
    expired: "Expired",
    suspended: "Suspended",
    viewsLabel: "Views",
    promotionPhone: "Phone",
    processedAt: "Processed",
    promotionProcessed: "Marked as processed",
    promotionReopened: "Reopened",
    reopen: "Reopen",
    noPendingPromotions: "No promotion requests waiting",
    noPromotionsFound: "No promotion requests found",
    noUsersFound: "No members found",
    userListings: "Their listings",
    joinedDate: "Joined",
    role: "Role",
    role_user: "Member",
    ...
    accountSuspendedToast: "Account suspended",
    accountActivatedToast: "Account reactivated",
    promoteToModerator: "Make moderator",
    demoteToUser: "Remove moderator",
    roleUpdated: "Role updated",
    adminAccountsProtected: "Admin accounts cannot be changed from here.",
    deleteUserTitle: "Delete this account?",
    deleteUserBody: "Every listing, photo, comment and notification belonging to {name} is erased. Suspending stops them signing in and keeps all of it.",
    resetPasswordAdminBody: "Set a new password for {name}. Verify who you are talking to before you do — this hands over their account.",
    ...
    contactStatus_new: "New",
    contactStatus_in_progress: "In progress",
    contactStatus_resolved: "Resolved",
    contactStatus_closed: "Closed",
    searchMessages: "Search messages…",
    noMessagesFound: "No messages",
    messageUpdated: "Message updated",
    messageDeleted: "Message deleted",
    deleteMessageTitle: "Delete this message?",
    deleteMessageBody: "It is removed from the inbox for good.",
    adminResponsePlaceholder: "Notes on how this was handled…",
    adminResponseHint: "Saved with the message for the record. Reply to the sender by email.",
    noResetRequestsFound: "No requests waiting",
    noResetRequestsBody: "Nobody is locked out right now.",
    resetRequestUpdated: "Request updated",
    resetRequestAdminHint: "Verify this person out of band, then set their password from Members.",
    findAccount: "Find account",
    copy: "Copy",
    copiedToClipboard: "Copied",
    code: "Code",
    capitalCity: "Capital",
    pickACountry: "Pick a country",
    pickACountryBody: "Cities are edited one country at a time.",
    citiesCount: "{count} cities",
    cityUpdatedSuccessfully: "City updated",
    cityDeletedSuccessfully: "City deleted",
    errorUpdatingCity: "Could not update the city",
    errorDeletingCity: "Could not delete the city",
    deleteCityTitle: "Delete this city?",
    deleteCityBody: "Listings already filed under it keep pointing at a city that no longer exists.",
    language_en: "English",
    language_fr: "French",
    language_ar: "Arabic",
    ...
    maintenanceOn: "On",
    maintenanceOff: "Off",
    maintenanceOnBody: "The site is closed to everyone except admins.",
    maintenanceOffBody: "The site is open. Turning this on closes it to everyone except admins.",
    maintenanceActiveTitle: "Maintenance mode is on",
    maintenanceActiveBody: "Visitors and members cannot use the site right now.",
    maintenanceMessage: "Message shown to visitors",
    maintenanceMessagePlaceholder: "We are carrying out scheduled work and will be back shortly.",
    estimatedReturn: "Back in",
    estimatedReturnPlaceholder: "2 hours",
    estimatedReturnHint: "Optional",
    enableMaintenanceTitle: "Close the site?",
    enableMaintenanceBody: "Everyone except admins is shut out until you turn this back off.",
    enableMaintenance: "Close the site",
    maintenanceEnabled: "Maintenance mode on",
    maintenanceDisabled: "Maintenance mode off",
    maintenanceSettingsSaved: "Settings saved",
    lastChangedBy: "Last changed by {name}, {time}",
    neverChanged: "Never changed",
    database: "Database",
    storageUsage: "Storage",
    storageHint: "{data} MB of documents",
    activeConnections: "Open connections",
    connectionsHint: "Free tier allows 100",
    p95Latency: "Latency (p95)",
    latencyHint: "Watch above 200 ms",
    throughputOps: "Throughput",
    opsPerSecond: "{value} ops/sec",
    opsBreakdown: "insert {insert} · read {query} · update {update} · delete {remove}",
    dbHealthy: "Healthy",
    dbWatch: "Approaching the limits",
    dbSwitchNow: "Over the limits",
    errorLoadingMetrics: "Could not read the database metrics",
    activityLog: "Activity log",
    action: "Action",
    allActions: "Everything",
    performedBy: "By",
    targetType: "On",
    targetType_post: "Listing",
    targetType_user: "Member",
    targetType_report: "Report",
    targetType_comment: "Comment",
    targetType_contact: "Message",
    targetType_city: "City",
    targetType_promotion: "Promotion",
    targetType_resetRequest: "Password request",
    targetType_system: "System",
    noAuditEntries: "Nothing recorded yet",
    noAuditEntriesBody: "Admin actions taken from this panel appear here.",
    auditRetentionHint: "Every action taken from this panel, kept for 90 days.",
    "auditAction_report.pending": "Reopened a report",
    "auditAction_report.reviewed": "Marked a report reviewed",
    "auditAction_report.resolved": "Resolved a report",
    "auditAction_report.dismissed": "Dismissed a report",
    "auditAction_promotion.process": "Processed a promotion",
    "auditAction_promotion.reopen": "Reopened a promotion",
    "auditAction_post.delete": "Deleted a listing",
    "auditAction_post.status.active": "Restored a listing",
    "auditAction_post.status.suspended": "Suspended a listing",
    "auditAction_post.status.resolved": "Closed a listing",
    "auditAction_post.status.expired": "Expired a listing",
    "auditAction_user.delete": "Deleted an account",
    "auditAction_user.resetPassword": "Reset a password",
    "auditAction_user.activate": "Reactivated an account",
    "auditAction_user.deactivate": "Suspended an account",
    "auditAction_user.role": "Changed a role",
    "auditAction_comment.remove": "Removed a comment",
    "auditAction_comment.restore": "Restored a comment",
    "auditAction_resetRequest.pending": "Reopened a password request",
    "auditAction_resetRequest.processed": "Processed a password request",
    "auditAction_resetRequest.rejected": "Rejected a password request",
    paginationRange: "{from}–{to} of {total}",
    pageOf: "{page} / {total}",
    perPageCount: "{count} / page",
    ...
    typeToConfirmField: "Confirmation",
    genericActionError: "That did not work. Try again.",
    genericLoadError: "Could not load this.",
    justNow: "just now",
    ...
    // SEO copy for individual post pages (see utils/postSeo.js)
    seoPostTitleFound: "Found: {item} in {city} | Mafqoudat",
    seoPostTitleLost: "Lost: {item} in {city} | Mafqoudat",
    seoPostTitleUnknown: "{item} in {city} | Mafqoudat",
    seoPostDescFound: "Found {item} in {city}. See the full details and contact the finder on Mafqoudat, the lost and found platform in {country}.",
    seoPostDescLost: "Lost {item} in {city}. See the full details and help return it to its owner on Mafqoudat, the lost and found platform in {country}.",
    seoPostDescUnknown: "{item} in {city}. See the full details on Mafqoudat, the lost and found platform in {country}.",
    seoDefaultRegion: "Morocco and the Arab world",
    seoPostNotFoundTitle: "Post Not Found | Mafqoudat",
    seoPostNotFoundDescription: "This lost and found post is no longer available on Mafqoudat.",
    postLoadFailedTitle: "Failed to load post",
    postLoadFailedMessage: "The post may have been deleted or doesn't exist",
    ...
    depManagerSubtitle: "Manage system dependencies and configurations",
    foundLostOptions: "Found/Lost Options",
    depManagerCountrySingular: "Country",
    depManagerCategorySingular: "Category",
    depManagerFoundLostSingular: "Found/Lost Option",
    depManagerItemsAvailable: "{count} items available",
    depManagerAddItem: "Add {type}",
    depManagerNewItem: "Add New {type}",
    depManagerNoItemsFound: "No {type} found",
    depManagerClickAddToCreate: "Click the Add button to create your first item",
    depManagerLabelField: "Label",
    depManagerFlagOptional: "Flag (optional)",
    depManagerCreate: "Create",
    depManagerCreating: "Creating...",
    depManagerIdPrefix: "ID: {id}",
    depManagerCodeExampleCountry: "US, UK, FR",
    depManagerCodeExampleCategory: "Vehicle, Electronics",
    depManagerCodeExampleFoundLost: "Found, Lost",
    depManagerCountryLabelExample: "United States, United Kingdom",
    depManagerFlagExample: "🚗, 📱, 💼",
    ...
    searchCityPlaceholder: "Search for city",
    ...
    // Mobile-width auth screens, mirroring the Expo app's Login/SignUp copy
    ...
    faceBlurOnHint: "Their eyes are covered in the photo that will be published. This happens on your device - the original is never uploaded.",
    faceBlurOffHint: "The photo will be published with the faces fully visible.",
    faceBlurToggleLabel: "Hide eyes",
    discardPostTitle: "Discard post?",
    discardPostMessage: "You have unsaved changes. Are you sure you want to leave? Your progress will be lost.",
    ...
    selectedDocumentTitles: "Document",
    ...
    confirmDocumentTitles: "Confirm ({count})",
    ...
    // Custom date entry dialog (replaces free-text / calendar date input)
    datePickerOpen: "Click to choose the date",
    ...
    locationData: "Approximate location from your IP address, used only to suggest your country when you first open the app (not GPS, not stored)",
    crashDiagnosticsData: "Crash reports and diagnostic data when the app encounters an error, to help us find and fix bugs",
    ...
    articleNotFoundDescription: "The article you're looking for doesn't exist or may have been moved.",
    safety: "Safety",
    guidelines: "Guidelines",
    success: "Success",
    tips: "Tips",
    ...
    pushOfferTitle: "Get told the moment it turns up",
    pushOfferBody: "We compare every new listing with yours. Turn on notifications and we'll let you know as soon as someone posts an item that looks like this one.",
    pushOfferPointMatch: "Only when a listing looks like yours — never marketing.",
    pushOfferPointClosed: "Reaches you even when Mafqoudat is closed.",
    pushOfferPointOff: "Turn it off any time in your alert settings.",
    pushOfferEnable: "Enable notifications",
    pushOfferSkip: "Not now",
    pushOfferFootnote: "Either way, your listing is published right after this.",
    notifPrefPushAlerts: "Push notifications",
    notifPrefPushAlertsDescription: "Master switch for alerts pushed to your phone and your browsers. In-app alerts keep working either way.",
    notifPrefBrowserAlerts: "Browser notifications",
    notifPrefBrowserAlertsDescription: "Get alerts on this device, even when Mafqoudat is closed.",
    notifPrefBrowserAlertsBlocked: "Notifications are blocked for this site. Allow them in your browser settings to turn this on.",
    notifPrefBrowserAlertsUnsupported: "This browser can't show notifications. On iPhone, add Mafqoudat to your Home Screen first.",
    notifPrefBrowserAlertsEnable: "Turn on",
    notifPrefBrowserAlertsMuted: "This browser is subscribed, but push notifications are turned off above, so nothing is delivered to it.",
  ...
  fr: {
    ...
    adminGroupOperations: "Opérations",
    adminGroupCatalog: "Catalogue",
    adminGroupInsights: "Analyses",
    adminGroupSystem: "Système",
    adminNavOverview: "Vue d'ensemble",
    adminNavOverviewDescription: "Ce qui demande une action maintenant, et l'état du site.",
    adminNavModeration: "Modération",
    adminNavModerationDescription: "Signalements d'annonces et de commentaires, et les fils de commentaires.",
    adminNavPosts: "Annonces",
    adminNavPostsDescription: "Toutes les annonces d'objets perdus et trouvés du site.",
    adminNavUsers: "Membres",
    adminNavUsersDescription: "Comptes, rôles et accès.",
    adminNavPromotions: "Promotions",
    adminNavPromotionsDescription: "Annonces dont le propriétaire a demandé la promotion.",
    adminNavSupport: "Assistance",
    adminNavSupportDescription: "Messages du formulaire de contact et demandes de réinitialisation de mot de passe.",
    adminNavAnalytics: "Analyses",
    adminNavAnalyticsDescription: "Visiteurs, annonces et membres sur la période de votre choix.",
    adminNavPlaces: "Lieux",
    adminNavPlacesDescription: "Les villes de chaque pays couvert par le site.",
    adminNavSystem: "Système",
    adminNavSystemDescription: "Mode maintenance, état de la base de données et journal d'activité.",
    needsAttention: "À traiter",
    needsAttentionBody: "Files en attente d'une décision.",
    queuesClearTitle: "Tout est traité",
    queuesClearBody: "Aucun signalement, demande de promotion ou message d'assistance en attente.",
    atAGlance: "En un coup d'œil",
    last30Days: "30 derniers jours",
    latestListings: "Dernières annonces",
    newestMembers: "Nouveaux membres",
    topCategories: "Principales catégories",
    topCities: "Principales villes",
    lostVsFound: "Perdus / trouvés",
    listingStatusBreakdown: "Statut des annonces",
    newListingsPerDay: "Nouvelles annonces par jour",
    newListingsPerDayHint: "Annonces d'objets perdus et trouvés créées chaque jour.",
    signupsPerDay: "Inscriptions par jour",
    visitorsPerDay: "Visiteurs par jour",
    itemsReturnedPerDay: "Objets rendus par jour",
    itemsReturnedPerDayHint: "Annonces marquées comme résolues chaque jour.",
    itemsReturned: "Objets rendus",
    listingsWithPhoto: "Avec photo",
    siteComments: "Commentaires",
    visitorsToday: "Visiteurs aujourd'hui",
    visitors: "Visiteurs",
    newListings: "Nouvelles annonces",
    newMembers: "Nouveaux membres",
    listingViewsTotal: "Vues des annonces",
    sessionsAllTime: "{count} au total",
    shareOfAllListings: "{value}% des annonces",
    vsPrevious7Days: "vs 7 jours précédents",
    vsPreviousPeriod: "vs {days} jours précédents",
    lastUpdatedAt: "Mis à jour {time}",
    ...
    whereVisitorsCameFrom: "D'où viennent les visiteurs",
    visitorGeographyHint: "Déterminé à partir de la visite ; les sessions non localisées sont exclues.",
    countries: "Pays",
    cities: "Villes",
    landingPages: "Pages d'entrée",
    mostViewedListings: "Annonces les plus vues",
    reports: "Signalements",
    reportedContent: "Contenu signalé",
    reportKind: "Type de signalement",
    allKinds: "Tous les types",
    listingReport: "Annonce",
    commentReport: "Commentaire",
    reportedListing: "Annonce signalée",
    reportedComment: "Commentaire signalé",
    commentUnavailable: "Ce commentaire n'est plus disponible",
    byUser: "par {name}",
    details: "Détails",
    review: "Examiner",
    reportUpdated: "Signalement mis à jour",
    noPendingReports: "Aucun signalement en attente",
    noPendingReportsBody: "Tous les signalements ont été traités.",
    ...
    restoreComment: "Restaurer le commentaire",
    removeCommentTitle: "Retirer ce commentaire ?",
    removeCommentBody: "Il n'apparaîtra plus sur l'annonce. Le texte est conservé pour qu'un signalement reste examinable, et vous pouvez le restaurer.",
    commentRemoved: "Commentaire retiré",
    commentRestored: "Commentaire restauré",
    removed: "Retiré",
    visible: "Visible",
    hidden: "Masqué",
    listing: "Annonce",
    listingDetails: "Détails de l'annonce",
    searchPostsAdmin: "Rechercher description ou lieu…",
    allCountries: "Tous les pays",
    noPostsFoundFiltered: "Aucun résultat pour ces filtres.",
    suspendListing: "Suspendre",
    restoreListing: "Restaurer",
    listingSuspended: "Annonce suspendue",
    listingRestored: "Annonce restaurée",
    listingStatusUpdated: "Annonce marquée {status}",
    markAs: "Marquer comme {status}",
    deleteListingTitle: "Supprimer cette annonce ?",
    deleteListingBody: "Sa photo, ses commentaires et les signalements associés seront supprimés. La suspension la retire du site sans rien perdre.",
    expired: "Expirée",
    suspended: "Suspendue",
    viewsLabel: "Vues",
    promotionPhone: "Téléphone",
    processedAt: "Traité le",
    promotionProcessed: "Marqué comme traité",
    promotionReopened: "Rouvert",
    reopen: "Rouvrir",
    noPendingPromotions: "Aucune demande de promotion en attente",
    noPromotionsFound: "Aucune demande de promotion trouvée",
    noUsersFound: "Aucun membre trouvé",
    userListings: "Ses annonces",
    ...
    accountActive: "Actif",
    accountSuspended: "Suspendu",
    suspendAccount: "Suspendre le compte",
    activateAccount: "Réactiver le compte",
    accountSuspendedToast: "Compte suspendu",
    accountActivatedToast: "Compte réactivé",
    promoteToModerator: "Nommer modérateur",
    demoteToUser: "Retirer le rôle de modérateur",
    roleUpdated: "Rôle mis à jour",
    adminAccountsProtected: "Les comptes administrateurs ne se modifient pas ici.",
    deleteUserTitle: "Supprimer ce compte ?",
    deleteUserBody: "Toutes les annonces, photos, commentaires et notifications de {name} seront effacés. La suspension l'empêche de se connecter sans rien perdre.",
    resetPasswordAdminBody: "Définir un nouveau mot de passe pour {name}. Vérifiez l'identité de votre interlocuteur au préalable : cela donne accès au compte.",
    generatePassword: "En générer un solide",
    ...
    contactStatus_new: "Nouveau",
    contactStatus_in_progress: "En cours",
    contactStatus_resolved: "Résolu",
    contactStatus_closed: "Clos",
    searchMessages: "Rechercher des messages…",
    noMessagesFound: "Aucun message",
    messageUpdated: "Message mis à jour",
    messageDeleted: "Message supprimé",
    deleteMessageTitle: "Supprimer ce message ?",
    deleteMessageBody: "Il sera définitivement retiré de la boîte de réception.",
    adminResponsePlaceholder: "Notes sur le traitement de ce message…",
    adminResponseHint: "Enregistré avec le message à titre de trace. Répondez à l'expéditeur par e-mail.",
    noResetRequestsFound: "Aucune demande en attente",
    noResetRequestsBody: "Personne n'est bloqué en ce moment.",
    resetRequestUpdated: "Demande mise à jour",
    resetRequestAdminHint: "Vérifiez l'identité de la personne par un autre canal, puis définissez son mot de passe depuis Membres.",
    findAccount: "Trouver le compte",
    copy: "Copier",
    copiedToClipboard: "Copié",
    code: "Code",
    capitalCity: "Capitale",
    pickACountry: "Choisissez un pays",
    pickACountryBody: "Les villes se modifient pays par pays.",
    citiesCount: "{count} villes",
    cityUpdatedSuccessfully: "Ville mise à jour",
    cityDeletedSuccessfully: "Ville supprimée",
    errorUpdatingCity: "Impossible de mettre à jour la ville",
    errorDeletingCity: "Impossible de supprimer la ville",
    deleteCityTitle: "Supprimer cette ville ?",
    deleteCityBody: "Les annonces déjà rattachées à cette ville pointeront vers une ville inexistante.",
    language_en: "Anglais",
    language_fr: "Français",
    language_ar: "Arabe",
    maintenanceMode: "Mode maintenance",
    maintenanceOn: "Activé",
    maintenanceOff: "Désactivé",
    maintenanceOnBody: "Le site est fermé à tous sauf aux administrateurs.",
    maintenanceOffBody: "Le site est ouvert. L'activer le ferme à tous sauf aux administrateurs.",
    maintenanceActiveTitle: "Le mode maintenance est activé",
    maintenanceActiveBody: "Les visiteurs et les membres ne peuvent pas utiliser le site actuellement.",
    maintenanceMessage: "Message affiché aux visiteurs",
    maintenanceMessagePlaceholder: "Une opération de maintenance est en cours, nous revenons très vite.",
    estimatedReturn: "Retour dans",
    estimatedReturnPlaceholder: "2 heures",
    estimatedReturnHint: "Facultatif",
    enableMaintenanceTitle: "Fermer le site ?",
    enableMaintenanceBody: "Tout le monde sauf les administrateurs sera bloqué jusqu'à la désactivation.",
    enableMaintenance: "Fermer le site",
    maintenanceEnabled: "Mode maintenance activé",
    maintenanceDisabled: "Mode maintenance désactivé",
    maintenanceSettingsSaved: "Paramètres enregistrés",
    lastChangedBy: "Dernière modification par {name}, {time}",
    neverChanged: "Jamais modifié",
    database: "Base de données",
    storageUsage: "Stockage",
    storageHint: "{data} Mo de documents",
    activeConnections: "Connexions ouvertes",
    connectionsHint: "L'offre gratuite en autorise 100",
    p95Latency: "Latence (p95)",
    latencyHint: "Surveiller au-delà de 200 ms",
    throughputOps: "Débit",
    opsPerSecond: "{value} op/s",
    opsBreakdown: "insertion {insert} · lecture {query} · mise à jour {update} · suppression {remove}",
    dbHealthy: "Tout va bien",
    dbWatch: "Proche des limites",
    dbSwitchNow: "Limites dépassées",
    errorLoadingMetrics: "Impossible de lire les métriques de la base",
    activityLog: "Journal d'activité",
    action: "Action",
    allActions: "Tout",
    performedBy: "Par",
    targetType: "Sur",
    targetType_post: "Annonce",
    targetType_user: "Membre",
    targetType_report: "Signalement",
    targetType_comment: "Commentaire",
    targetType_contact: "Message",
    targetType_city: "Ville",
    targetType_promotion: "Promotion",
    targetType_resetRequest: "Demande de mot de passe",
    targetType_system: "Système",
    noAuditEntries: "Rien d'enregistré pour l'instant",
    noAuditEntriesBody: "Les actions effectuées depuis ce panneau apparaissent ici.",
    auditRetentionHint: "Chaque action effectuée depuis ce panneau, conservée 90 jours.",
    "auditAction_report.pending": "Signalement rouvert",
    "auditAction_report.reviewed": "Signalement marqué comme examiné",
    "auditAction_report.resolved": "Signalement résolu",
    "auditAction_report.dismissed": "Signalement rejeté",
    "auditAction_promotion.process": "Promotion traitée",
    "auditAction_promotion.reopen": "Promotion rouverte",
    "auditAction_post.delete": "Annonce supprimée",
    "auditAction_post.status.active": "Annonce restaurée",
    "auditAction_post.status.suspended": "Annonce suspendue",
    "auditAction_post.status.resolved": "Annonce clôturée",
    "auditAction_post.status.expired": "Annonce expirée",
    "auditAction_user.delete": "Compte supprimé",
    "auditAction_user.resetPassword": "Mot de passe réinitialisé",
    "auditAction_user.activate": "Compte réactivé",
    "auditAction_user.deactivate": "Compte suspendu",
    "auditAction_user.role": "Rôle modifié",
    "auditAction_comment.remove": "Commentaire retiré",
    "auditAction_comment.restore": "Commentaire restauré",
    "auditAction_resetRequest.pending": "Demande de mot de passe rouverte",
    "auditAction_resetRequest.processed": "Demande de mot de passe traitée",
    "auditAction_resetRequest.rejected": "Demande de mot de passe rejetée",
    ...
    typeToConfirmField: "Confirmation",
    genericActionError: "L'opération a échoué. Réessayez.",
    genericLoadError: "Impossible de charger ces données.",
    justNow: "à l'instant",
    ...
    // Textes SEO pour les pages de publication (voir utils/postSeo.js)
    seoPostTitleFound: "Trouvé : {item} à {city} | Mafqoudat",
    seoPostTitleLost: "Perdu : {item} à {city} | Mafqoudat",
    seoPostTitleUnknown: "{item} à {city} | Mafqoudat",
    // "Annonce d'objet perdu/trouvé" keeps the searched keywords while making
    // "objet" the antecedent, so the participles and pronouns agree regardless
    // of the category's own gender ("Carte d'identité perdu" would not).
    seoPostDescFound: "Annonce d'objet trouvé à {city} : {item}. Détails et contact sur Mafqoudat, plateforme d'objets perdus et trouvés ({country}).",
    seoPostDescLost: "Annonce d'objet perdu à {city} : {item}. Détails et contact sur Mafqoudat, plateforme d'objets perdus et trouvés ({country}).",
    seoPostDescUnknown: "{item} à {city}. Détails et contact sur Mafqoudat, plateforme d'objets perdus et trouvés ({country}).",
    seoDefaultRegion: "Maroc et monde arabe",
    seoPostNotFoundTitle: "Publication introuvable | Mafqoudat",
    seoPostNotFoundDescription: "Cette publication d'objet perdu ou trouvé n'est plus disponible sur Mafqoudat.",
    postLoadFailedTitle: "Échec du chargement de la publication",
    postLoadFailedMessage: "La publication a peut-être été supprimée ou n'existe pas",
    postNotFoundTitle: "Publication introuvable",
    postNotFoundMessage: "La publication que vous recherchez n'existe pas ou a été supprimée",
    ...
    depManagerSubtitle: "Gérer les dépendances et configurations du système",
    foundLostOptions: "Options Trouvé/Perdu",
    depManagerCountrySingular: "Pays",
    depManagerCategorySingular: "Catégorie",
    depManagerFoundLostSingular: "Option Trouvé/Perdu",
    depManagerItemsAvailable: "{count} éléments disponibles",
    depManagerAddItem: "Ajouter {type}",
    depManagerNewItem: "Ajouter un nouveau {type}",
    depManagerNoItemsFound: "Aucun {type} trouvé",
    depManagerClickAddToCreate: "Cliquez sur le bouton Ajouter pour créer votre premier élément",
    depManagerLabelField: "Libellé",
    depManagerFlagOptional: "Drapeau (optionnel)",
    depManagerCreate: "Créer",
    depManagerCreating: "Création...",
    depManagerIdPrefix: "ID : {id}",
    depManagerCodeExampleCountry: "US, UK, FR",
    depManagerCodeExampleCategory: "Véhicule, Électronique",
    depManagerCodeExampleFoundLost: "Trouvé, Perdu",
    depManagerCountryLabelExample: "États-Unis, Royaume-Uni",
    depManagerFlagExample: "🚗, 📱, 💼",
    ...
    filterType: "Type",
    typeFilterLost: "Perdu",
    typeFilterFound: "Trouvé",
    pending: "En attente",
    reviewed: "Examiné",
    resolved: "Résolu",
    dismissed: "Rejeté",
    ...
    faceBlurScanning: "Analyse de la photo à la recherche de visages...",
    faceBlurFoundOne: "1 visage détecté sur cette photo",
    faceBlurFoundTwo: "2 visages détectés sur cette photo",
    faceBlurFoundMany: "{count} visages détectés sur cette photo",
    faceBlurOnHint: "Les yeux sont masqués sur la photo qui sera publiée. Le traitement a lieu sur votre appareil - l'original n'est jamais envoyé.",
    faceBlurOffHint: "La photo sera publiée avec les visages entièrement visibles.",
    faceBlurToggleLabel: "Masquer les yeux",
    discardPostTitle: "Abandonner la publication ?",
    discardPostMessage: "Vous avez des modifications non enregistrées. Voulez-vous vraiment quitter ? Vos données seront perdues.",
    continueFilling: "Continuer à remplir",
    ...
    confirmDocumentTitles: "Confirmer ({count})",
    ...
    // Custom date entry dialog (replaces free-text / calendar date input)
    datePickerOpen: "Cliquez pour choisir la date",
    ...
    locationData: "Localisation approximative déduite de votre adresse IP, utilisée uniquement pour suggérer votre pays à la première ouverture de l'application (pas de GPS, non conservée)",
    crashDiagnosticsData: "Rapports de plantage et données de diagnostic en cas d'erreur de l'application, pour nous aider à identifier et corriger les bugs",
    ...
    articleNotFoundDescription: "L'article que vous recherchez n'existe pas ou a peut-être été déplacé.",
    safety: "Sécurité",
    guidelines: "Directives",
    success: "Succès",
    tips: "Conseils",
    ...
    notifSeeAll: "Voir toutes les notifications",
    ...
    pushOfferTitle: "Soyez prévenu dès qu'il réapparaît",
    pushOfferBody: "Nous comparons chaque nouvelle annonce à la vôtre. Activez les notifications et nous vous préviendrons dès que quelqu'un publie un objet qui ressemble à celui-ci.",
    pushOfferPointMatch: "Uniquement quand une annonce ressemble à la vôtre — jamais de publicité.",
    pushOfferPointClosed: "Vous atteint même quand Mafqoudat est fermé.",
    pushOfferPointOff: "Désactivable à tout moment dans vos paramètres d'alertes.",
    pushOfferEnable: "Activer les notifications",
    pushOfferSkip: "Pas maintenant",
    pushOfferFootnote: "Dans les deux cas, votre annonce est publiée juste après.",
    notifPrefPushAlerts: "Notifications push",
    notifPrefPushAlertsDescription: "Interrupteur général des alertes envoyées à votre téléphone et à vos navigateurs. Les alertes dans l'application continuent dans tous les cas.",
    notifPrefBrowserAlerts: "Notifications du navigateur",
    notifPrefBrowserAlertsDescription: "Recevoir les alertes sur cet appareil, même quand Mafqoudat est fermé.",
    notifPrefBrowserAlertsBlocked: "Les notifications sont bloquées pour ce site. Autorisez-les dans les paramètres de votre navigateur pour activer cette option.",
    notifPrefBrowserAlertsUnsupported: "Ce navigateur ne peut pas afficher de notifications. Sur iPhone, ajoutez d'abord Mafqoudat à l'écran d'accueil.",
    notifPrefBrowserAlertsEnable: "Activer",
    notifPrefBrowserAlertsMuted: "Ce navigateur est bien abonné, mais les notifications push sont désactivées ci-dessus : rien ne lui est envoyé.",
  ...
  ar: {
    ...
    adminGroupOperations: "العمليات",
    adminGroupCatalog: "المحتوى",
    adminGroupInsights: "التحليلات",
    adminGroupSystem: "النظام",
    adminNavOverview: "نظرة عامة",
    adminNavOverviewDescription: "ما يحتاج إلى إجراء الآن، وحالة الموقع.",
    adminNavModeration: "الإشراف",
    adminNavModerationDescription: "البلاغات عن المنشورات والتعليقات، والتعليقات نفسها.",
    adminNavPosts: "المنشورات",
    adminNavPostsDescription: "كل منشورات المفقودات والموجودات في الموقع.",
    adminNavUsers: "الأعضاء",
    adminNavUsersDescription: "الحسابات والأدوار وصلاحيات الدخول.",
    adminNavPromotions: "طلبات الترويج",
    adminNavPromotionsDescription: "منشورات طلب أصحابها ترويجها.",
    adminNavSupport: "الدعم",
    adminNavSupportDescription: "رسائل نموذج الاتصال وطلبات استعادة كلمة المرور.",
    adminNavAnalytics: "الإحصائيات",
    adminNavAnalyticsDescription: "الزوار والمنشورات والأعضاء خلال الفترة التي تختارها.",
    adminNavPlaces: "الأماكن",
    adminNavPlacesDescription: "المدن في كل دولة يغطيها الموقع.",
    adminNavSystem: "النظام",
    adminNavSystemDescription: "وضع الصيانة وحالة قاعدة البيانات وسجل نشاط الإدارة.",
    needsAttention: "يحتاج إلى إجراء",
    needsAttentionBody: "طلبات في انتظار قرار.",
    queuesClearTitle: "لا يوجد ما ينتظر",
    queuesClearBody: "لا توجد بلاغات أو طلبات ترويج أو رسائل دعم في الانتظار.",
    atAGlance: "لمحة سريعة",
    last30Days: "آخر 30 يوماً",
    latestListings: "أحدث المنشورات",
    newestMembers: "أحدث الأعضاء",
    topCategories: "أكثر الفئات",
    topCities: "أكثر المدن",
    lostVsFound: "المفقود مقابل الموجود",
    listingStatusBreakdown: "حالة المنشورات",
    newListingsPerDay: "المنشورات الجديدة يومياً",
    newListingsPerDayHint: "المنشورات المضافة كل يوم، مفقودة وموجودة.",
    signupsPerDay: "التسجيلات يومياً",
    visitorsPerDay: "الزوار يومياً",
    itemsReturnedPerDay: "الأغراض المسترجعة يومياً",
    itemsReturnedPerDayHint: "المنشورات التي تم إغلاقها كل يوم.",
    itemsReturned: "أغراض مسترجعة",
    listingsWithPhoto: "بصورة",
    siteComments: "التعليقات",
    visitorsToday: "زوار اليوم",
    visitors: "الزوار",
    newListings: "منشورات جديدة",
    newMembers: "أعضاء جدد",
    listingViewsTotal: "مشاهدات المنشورات",
    sessionsAllTime: "{count} إجمالاً",
    shareOfAllListings: "{value}٪ من المنشورات",
    vsPrevious7Days: "مقارنة بـ 7 أيام سابقة",
    vsPreviousPeriod: "مقارنة بـ {days} يوماً سابقة",
    lastUpdatedAt: "آخر تحديث {time}",
    noDataYet: "لا توجد بيانات بعد",
    viewAll: "عرض الكل",
    inThisPeriod: "خلال هذه الفترة",
    overTime: "التطور الزمني",
    dateRange: "الفترة",
    rangeDays: "{days} يوماً",
    allTime: "منذ البداية",
    whereVisitorsCameFrom: "من أين جاء الزوار",
    visitorGeographyHint: "مستخلص من الزيارة نفسها؛ الجلسات التي تعذّر تحديدها غير مدرجة.",
    countries: "الدول",
    cities: "المدن",
    landingPages: "صفحات الدخول",
    mostViewedListings: "أكثر المنشورات مشاهدة",
    reports: "البلاغات",
    reportedContent: "المحتوى المبلّغ عنه",
    reportKind: "نوع البلاغ",
    allKinds: "كل الأنواع",
    listingReport: "منشور",
    commentReport: "تعليق",
    reportedListing: "المنشور المبلّغ عنه",
    reportedComment: "التعليق المبلّغ عنه",
    commentUnavailable: "هذا التعليق لم يعد متاحاً",
    byUser: "بواسطة {name}",
    details: "التفاصيل",
    review: "مراجعة",
    reportUpdated: "تم تحديث البلاغ",
    noPendingReports: "لا توجد بلاغات في الانتظار",
    noPendingReportsBody: "تمت معالجة جميع البلاغات.",
    noReportsFound: "لا توجد بلاغات",
    comment: "تعليق",
    author: "الكاتب",
    searchComments: "ابحث في التعليقات…",
    noCommentsFound: "لا توجد تعليقات",
    removeComment: "إخفاء التعليق",
    restoreComment: "إعادة التعليق",
    removeCommentTitle: "إخفاء هذا التعليق؟",
    removeCommentBody: "لن يظهر بعد الآن في المنشور. يبقى النص محفوظاً حتى يمكن مراجعة أي بلاغ عنه، ويمكنك إعادته لاحقاً.",
    commentRemoved: "تم إخفاء التعليق",
    commentRestored: "تمت إعادة التعليق",
    removed: "مُخفى",
    visible: "ظاهر",
    hidden: "مخفي",
    listing: "المنشور",
    listingDetails: "تفاصيل المنشور",
    searchPostsAdmin: "ابحث في الوصف والمكان…",
    allCountries: "كل الدول",
    noPostsFoundFiltered: "لا نتائج مطابقة لهذه المرشحات.",
    suspendListing: "تعليق",
    restoreListing: "إعادة",
    listingSuspended: "تم تعليق المنشور",
    listingRestored: "تمت إعادة المنشور",
    listingStatusUpdated: "تم تعيين المنشور: {status}",
    markAs: "تعيين كـ {status}",
    deleteListingTitle: "حذف هذا المنشور؟",
    deleteListingBody: "ستُحذف معه صورته وتعليقاته وأي بلاغ عنه. التعليق يزيله من الموقع دون فقدان أي شيء.",
    expired: "منتهية",
    suspended: "معلّقة",
    viewsLabel: "المشاهدات",
    promotionPhone: "الهاتف",
    processedAt: "تمت المعالجة",
    promotionProcessed: "تم وضع علامة معالج",
    promotionReopened: "أُعيد فتحه",
    reopen: "إعادة فتح",
    noPendingPromotions: "لا توجد طلبات ترويج في الانتظار",
    noPromotionsFound: "لا توجد طلبات ترويج",
    noUsersFound: "لا يوجد أعضاء",
    userListings: "منشورات العضو",
    ...
    accountSuspendedToast: "تم إيقاف الحساب",
    accountActivatedToast: "تم تفعيل الحساب",
    promoteToModerator: "ترقية إلى مشرف",
    demoteToUser: "إلغاء الإشراف",
    roleUpdated: "تم تحديث الدور",
    adminAccountsProtected: "لا يمكن تعديل حسابات المديرين من هنا.",
    deleteUserTitle: "حذف هذا الحساب؟",
    deleteUserBody: "ستُمحى كل منشورات {name} وصوره وتعليقاته وإشعاراته. الإيقاف يمنعه من الدخول ويحتفظ بكل ذلك.",
    resetPasswordAdminBody: "تعيين كلمة مرور جديدة لـ {name}. تحقق من هوية الشخص أولاً — هذا يمنحه الوصول إلى الحساب.",
    generatePassword: "توليد كلمة قوية",
    ...
    contactStatus_new: "جديد",
    contactStatus_in_progress: "قيد المعالجة",
    contactStatus_resolved: "تم الحل",
    contactStatus_closed: "مغلق",
    ...
    deleteMessageBody: "ستُزال نهائياً من صندوق الوارد.",
    adminResponsePlaceholder: "ملاحظات حول كيفية معالجة الرسالة…",
    adminResponseHint: "تُحفظ مع الرسالة للتوثيق. الرد على المُرسِل يتم عبر البريد الإلكتروني.",
    noResetRequestsFound: "لا توجد طلبات في الانتظار",
    noResetRequestsBody: "لا أحد محجوب عن حسابه حالياً.",
    resetRequestUpdated: "تم تحديث الطلب",
    resetRequestAdminHint: "تحقّق من هوية الشخص بوسيلة أخرى، ثم عيّن كلمة المرور من صفحة الأعضاء.",
    findAccount: "البحث عن الحساب",
    copy: "نسخ",
    copiedToClipboard: "تم النسخ",
    code: "الرمز",
    capitalCity: "عاصمة",
    pickACountry: "اختر دولة",
    pickACountryBody: "تُحرَّر المدن دولة بدولة.",
    citiesCount: "{count} مدينة",
    cityUpdatedSuccessfully: "تم تحديث المدينة",
    cityDeletedSuccessfully: "تم حذف المدينة",
    errorUpdatingCity: "تعذّر تحديث المدينة",
    errorDeletingCity: "تعذّر حذف المدينة",
    deleteCityTitle: "حذف هذه المدينة؟",
    deleteCityBody: "المنشورات المرتبطة بها ستشير إلى مدينة لم تعد موجودة.",
    language_en: "الإنجليزية",
    language_fr: "الفرنسية",
    language_ar: "العربية",
    maintenanceMode: "وضع الصيانة",
    maintenanceOn: "مُفعَّل",
    maintenanceOff: "مُعطَّل",
    maintenanceOnBody: "الموقع مغلق أمام الجميع باستثناء المديرين.",
    maintenanceOffBody: "الموقع مفتوح. تفعيل هذا الوضع يغلقه أمام الجميع باستثناء المديرين.",
    maintenanceActiveTitle: "وضع الصيانة مُفعَّل",
    maintenanceActiveBody: "لا يستطيع الزوار والأعضاء استخدام الموقع حالياً.",
    maintenanceMessage: "الرسالة الظاهرة للزوار",
    maintenanceMessagePlaceholder: "نقوم بأعمال صيانة مجدولة وسنعود قريباً.",
    estimatedReturn: "العودة خلال",
    estimatedReturnPlaceholder: "ساعتين",
    estimatedReturnHint: "اختياري",
    enableMaintenanceTitle: "إغلاق الموقع؟",
    enableMaintenanceBody: "سيُمنع الجميع باستثناء المديرين إلى أن تُعيد تعطيل هذا الوضع.",
    enableMaintenance: "إغلاق الموقع",
    maintenanceEnabled: "تم تفعيل وضع الصيانة",
    maintenanceDisabled: "تم تعطيل وضع الصيانة",
    maintenanceSettingsSaved: "تم حفظ الإعدادات",
    lastChangedBy: "آخر تغيير بواسطة {name}، {time}",
    neverChanged: "لم يُغيَّر بعد",
    database: "قاعدة البيانات",
    storageUsage: "التخزين",
    storageHint: "{data} ميغابايت من المستندات",
    activeConnections: "الاتصالات المفتوحة",
    connectionsHint: "الخطة المجانية تسمح بـ 100",
    p95Latency: "زمن الاستجابة (p95)",
    latencyHint: "راقب ما فوق 200 مللي ثانية",
    throughputOps: "معدل العمليات",
    opsPerSecond: "{value} عملية/ثانية",
    opsBreakdown: "إضافة {insert} · قراءة {query} · تحديث {update} · حذف {remove}",
    dbHealthy: "الوضع سليم",
    dbWatch: "الاقتراب من الحدود",
    dbSwitchNow: "تجاوز الحدود",
    errorLoadingMetrics: "تعذّر قراءة مؤشرات قاعدة البيانات",
    activityLog: "سجل النشاط",
    action: "الإجراء",
    allActions: "كل الإجراءات",
    performedBy: "بواسطة",
    targetType: "على",
    targetType_post: "منشور",
    targetType_user: "عضو",
    targetType_report: "بلاغ",
    targetType_comment: "تعليق",
    targetType_contact: "رسالة",
    targetType_city: "مدينة",
    targetType_promotion: "ترويج",
    targetType_resetRequest: "طلب كلمة مرور",
    targetType_system: "النظام",
    noAuditEntries: "لا يوجد نشاط مسجَّل بعد",
    noAuditEntriesBody: "تظهر هنا الإجراءات التي تُتخذ من هذه اللوحة.",
    auditRetentionHint: "كل إجراء يُتخذ من هذه اللوحة، محفوظ لمدة 90 يوماً.",
    "auditAction_report.pending": "أعاد فتح بلاغ",
    "auditAction_report.reviewed": "وضع بلاغاً قيد المراجعة",
    "auditAction_report.resolved": "أغلق بلاغاً",
    "auditAction_report.dismissed": "رفض بلاغاً",
    "auditAction_promotion.process": "عالج طلب ترويج",
    "auditAction_promotion.reopen": "أعاد فتح طلب ترويج",
    "auditAction_post.delete": "حذف منشوراً",
    "auditAction_post.status.active": "أعاد منشوراً",
    "auditAction_post.status.suspended": "علّق منشوراً",
    "auditAction_post.status.resolved": "أغلق منشوراً",
    "auditAction_post.status.expired": "أنهى منشوراً",
    "auditAction_user.delete": "حذف حساباً",
    "auditAction_user.resetPassword": "أعاد تعيين كلمة مرور",
    "auditAction_user.activate": "فعّل حساباً",
    "auditAction_user.deactivate": "أوقف حساباً",
    "auditAction_user.role": "غيّر دوراً",
    "auditAction_comment.remove": "أخفى تعليقاً",
    "auditAction_comment.restore": "أعاد تعليقاً",
    "auditAction_resetRequest.pending": "أعاد فتح طلب كلمة مرور",
    "auditAction_resetRequest.processed": "عالج طلب كلمة مرور",
    "auditAction_resetRequest.rejected": "رفض طلب كلمة مرور",
    paginationRange: "{from}–{to} من {total}",
    pageOf: "{page} / {total}",
    perPageCount: "{count} / صفحة",
    ...
    typeToConfirmField: "تأكيد",
    genericActionError: "لم تنجح العملية. حاول مجدداً.",
    genericLoadError: "تعذّر تحميل هذه البيانات.",
    justNow: "الآن",
    minutesAgoShort: "قبل {count} د",
    hoursAgoShort: "قبل {count} س",
    daysAgoShort: "قبل {count} ي",
    ...
    phoneNumberDescriptionLost: "سيتواصل معك فريقنا عبر هذا الرقم لمساعدتك في ترويج الغرض المفقود.",
    phoneNumberDescriptionFound: "سيتواصل معك فريقنا عبر هذا الرقم لمساعدتك في ترويج الغرض الذي وجدته.",
    ...
    // نصوص تحسين محركات البحث لصفحات المنشورات (انظر utils/postSeo.js)
    seoPostTitleFound: "عُثر على: {item} في {city} | مفقودات",
    seoPostTitleLost: "مفقود: {item} في {city} | مفقودات",
    seoPostTitleUnknown: "{item} في {city} | مفقودات",
    // Phrased around مصدر (verbal nouns) and a neutral referent so nothing has
    // to agree in gender with the category name ("محفظة مفقود" would be wrong).
    seoPostDescFound: "تم العثور على {item} في {city}. اطّلع على التفاصيل الكاملة وتواصل مع صاحب البلاغ عبر مفقودات، منصة المفقودات والموجودات في {country}.",
    seoPostDescLost: "بلاغ عن فقدان {item} في {city}. اطّلع على التفاصيل الكاملة وساعد في إعادة المفقود إلى صاحبه عبر مفقودات، منصة المفقودات والموجودات في {country}.",
    seoPostDescUnknown: "{item} في {city}. اطّلع على التفاصيل الكاملة عبر مفقودات، منصة المفقودات والموجودات في {country}.",
    seoDefaultRegion: "المغرب والعالم العربي",
    seoPostNotFoundTitle: "المنشور غير موجود | مفقودات",
    seoPostNotFoundDescription: "لم يعد هذا المنشور متاحاً على مفقودات.",
    postLoadFailedTitle: "تعذّر تحميل المنشور",
    postLoadFailedMessage: "ربما تم حذف المنشور أو أنه غير موجود",
    postNotFoundTitle: "المنشور غير موجود",
    postNotFoundMessage: "المنشور الذي تبحث عنه غير موجود أو تمت إزالته",
    ...
    quickActionsDesc: "ابدأ بهذه الإجراءات الأساسية",
    ...
    searchForItems: "ابحث عن الأغراض المفقودة أو التي عثر عليها في {country}...",
    searchForFoundItems: "ابحث عن الأغراض التي عثر عليها في {country}...",
    searchForLostItems: "ابحث عن الأغراض المفقودة في {country}...",
    users: "المستخدمون",
    settings: "الإعدادات",
    all: "الكل",
    viewAllPosts: "عرض جميع المنشورات",
    viewFoundItems: "عرض الأغراض التي عثر عليها",
    viewLostItems: "عرض الأغراض المفقودة",
    viewFOUNDItems: "عرض لائحة الأغراض التي عثر عليها",
    viewLOSTItems: "عرض لائحة الأغراض المفقودة",
    ...
    depManagerSubtitle: "إدارة تبعيات النظام وإعداداته",
    foundLostOptions: "خيارات مفقود/موجود",
    depManagerCountrySingular: "دولة",
    depManagerCategorySingular: "فئة",
    depManagerFoundLostSingular: "خيار مفقود/موجود",
    depManagerItemsAvailable: "{count} عنصر متاح",
    depManagerAddItem: "إضافة {type}",
    depManagerNewItem: "إضافة {type} جديد",
    depManagerNoItemsFound: "لا يوجد {type}",
    depManagerClickAddToCreate: "انقر على زر الإضافة لإنشاء أول عنصر",
    depManagerLabelField: "التسمية",
    depManagerFlagOptional: "الرمز التعبيري (اختياري)",
    depManagerCreate: "إنشاء",
    depManagerCreating: "جارٍ الإنشاء...",
    depManagerIdPrefix: "المعرف: {id}",
    depManagerCodeExampleCountry: "US, UK, FR",
    depManagerCodeExampleCategory: "مركبة، إلكترونيات",
    depManagerCodeExampleFoundLost: "موجود، مفقود",
    depManagerCountryLabelExample: "الولايات المتحدة، المملكة المتحدة",
    depManagerFlagExample: "🚗, 📱, 💼",
    ...
    filterType: "النوع",
    typeFilterLost: "مفقودات",
    typeFilterFound: "موجودات",
    pending: "معلق",
    ...
    trendingItem: "غرض متنوع",
    trendingItemDescription: "آخر غرض شائع في منطقتك",
    trending: "رائج",
    ...
    noPostsInCountryDescription: "لا توجد أغراض مفقودة أو عثر عليها في {countryName} بعد. كن أول من ينشر وساعد في بناء المجتمع!",
    ...
    noSearchResultsDescription: "لم يتم العثور على أغراض تطابق \"{query}\". جرب كلمات مفتاحية مختلفة أو أنشئ منشوراً جديداً.",
    ...
    noRecentFoundItems: "لا توجد أغراض عثر عليها مؤخراً",
    noRecentFoundItemsDescription: "لم يتم العثور على أغراض مؤخراً. راقب المنشورات الجديدة!",
    noRecentLostItems: "لا توجد أغراض مفقودة مؤخراً",
    noRecentLostItemsDescription: "لم يتم الإبلاغ عن أغراض مفقودة مؤخراً.",
    noSuccessStories: "لا توجد قصص نجاح بعد",
    noSuccessStoriesDescription: "كن أول من يشارك قصة نجاح عندما تجد أو تعيد غرضاً!",
    ...
    searchingForItems: "البحث عن الأغراض...",
    ...
    chooseCountryMessage: "اختر بلدك لرؤية الأغراض المفقودة والتي عثر عليها ذات الصلة في منطقتك",
    ...
    searchItemsDesc: "ابحث عن الأغراض المفقودة أو التي عثر عليها في بلدك",
    localPosts: "إنشاء منشور",
    localPostsDesc: "أنشئ منشورًا مجانًا حول الأغراض التي فقدتها أو عثرت عليها",
    ...
    imageWarningBulletUseNeutralBackground: "استخدم خلفية محايدة وركّز على المظهر العام للغرض.",
    ...
    faceBlurScanning: "جارٍ فحص الصورة بحثًا عن الوجوه...",
    faceBlurFoundOne: "تم العثور على وجه واحد في هذه الصورة",
    faceBlurFoundTwo: "تم العثور على وجهين في هذه الصورة",
    faceBlurFoundMany: "تم العثور على {count} وجوه في هذه الصورة",
    faceBlurOnHint: "سيتم إخفاء العينين في الصورة التي ستُنشر. تتم المعالجة على جهازك، ولا تُرفع الصورة الأصلية أبدًا.",
    faceBlurOffHint: "ستُنشر الصورة مع ظهور الوجوه بالكامل.",
    faceBlurToggleLabel: "إخفاء العينين",
    discardPostTitle: "تجاهل المنشور؟",
    discardPostMessage: "لديك تغييرات غير محفوظة. هل أنت متأكد أنك تريد المغادرة؟ سيتم فقدان المعلومات التي أدخلتها.",
    continueFilling: "متابعة التعبئة",
    discardAndExit: "تجاهل وخروج",
    ...
    selectedDocumentTitles: "الوثيقة",
    ...
    confirmDocumentTitles: "تأكيد ({count})",
    ...
    whatsappContactLostMessage: "سنستخدم رقم الواتساب هذا للتواصل معك إذا وجد شخص ما الغرض المفقود.",
    whatsappContactFoundMessage: "سنستخدم رقم الواتساب هذا للتواصل معك إذا أراد مالك الغرض الذي عثر عليه الوصول إليك.",
    phoneNumber: "رقم الهاتف",
    ...
    exactDateLostPlaceholder: "متى فقدت الغرض؟",
    exactDateFoundPlaceholder: "متى وجدت الغرض؟",
    exactDateLostPlaceholderOptional: "هل تتذكر متى فقدت الغرض؟",
    exactDateFoundPlaceholderOptional: "هل تتذكر متى وجدت الغرض؟",
    exactLocationLostPlaceholder: "أين فقدت الغرض؟ (مثال: الحديقة المركزية، ميدان تايمز، إلخ)",
    exactLocationFoundPlaceholder: "أين وجدت الغرض؟ (مثال: الحديقة المركزية، ميدان تايمز، إلخ)",
    descriptionLostPlaceholder: "صف الغرض الذي فقدته لمساعدة الآخرين في تحديده",
    descriptionFoundPlaceholder: "صف الغرض الذي وجدته لمساعدة المالك في تحديده",
    ...
    promoteYourFoundItem: "روج للغرض الذي وجدته",
    postPublishedSuccessfully: "تم نشر منشورك بنجاح!",
    foundItemPostedSuccessfully: "تم نشر الغرض الذي وجدته بنجاح!",
    ourTeamCanHelp: "هل تريد زيادة فرصك؟",
    ourTeamCanPromote: "هل تريد الترويج للغرض الذي وجدته؟",
    teamHasTechniques: "يتمتع فريقنا بتقنيات متخصصة لإظهار منشورك للأشخاص المتواجدين في الموقع الذي فقدت فيه الغرض.",
    teamHasPromotionTechniques: "يتمتع فريقنا بتقنيات متخصصة لإظهار منشورك للأشخاص المتواجدين في الموقع الذي وجدت فيه الغرض.",
    ...
    promotionDescription: "هل تريد منا الترويج لغرضك المفقود على قنوات وسائل التواصل الاجتماعي لزيادة فرصك في العثور عليه؟ سنتواصل معك لمعالجة طلبك.",
    emailNotification: "سنخطرك عبر البريد الإلكتروني عندما تكون الترويج جاهزاً",
    yesPromote: "ترويج",
    yesPromoteFound: "نعم، اروج للغرض الذي وجدته",
    noThanks: "لا، شكراً",
    ...
    phoneNumberRequiredLost: "رقم الهاتف مطلوب لترويج الأغراض المفقودة",
    phoneNumberRequiredFound: "رقم الهاتف مطلوب لترويج الأغراض الموجودة",
    ...
    markAsReturned: "تم",
    itemMarkedAsReturned: "تم وضع علامة على الغرض كمُرجع بنجاح!",
    ...
    // Your Posts Section
    yourPosts: "منشوراتك",
    yourPostsDesc: "إدارة ومشاهدة الأغراض التي نشرتها",
    noYourPosts: "لم تنشر أي أغراض بعد",
    ...
    howToReportLostItem: "كيفية الإبلاغ عن غرض مفقود؟",
    howToReportLostItemAnswer: "للإبلاغ عن غرض مفقود، اذهب إلى قسم 'الإبلاغ عن غرض مفقود' في لوحة التحكم واتبع التعليمات. ستحتاج إلى تقديم تفاصيل حول الغرض وموقعه وأي معلومات ذات صلة.",
    howToClaimFoundItem: "كيفية المطالبة بغرض عثر عليه؟",
    howToClaimFoundItemAnswer: "للمطالبة بغرض عثر عليه، اذهب إلى قسم 'الإبلاغ عن غرض عثر عليه' في لوحة التحكم واتبع التعليمات. ستحتاج إلى تقديم تفاصيل حول الغرض وموقعه.",
    whatInformationNeeded: "ما المعلومات التي أحتاجها؟",
    whatInformationNeededAnswer: "عند الإبلاغ عن غرض مفقود أو عثر عليه، ستحتاج إلى تقديم تفاصيل حول الغرض وموقعه وأي معلومات ذات صلة. هذا يساعدنا في مطابقتك مع المالك الصحيح أو الغرض المفقود.",
    police: "الشرطة",
    support: "الدعم",
    email: "البريد الإلكتروني",
    call: "اتصال",
    ...
    beHonestInReportsDesc: "قدم دائماً معلومات دقيقة وصادقة حول غرضك المفقود أو الذي عثر عليه.",
    provideClearDescriptions: "قدم أوصافاً واضحة",
    provideClearDescriptionsDesc: "استخدم أوصافاً واضحة ومفصلة في تقاريرك لمساعدة الآخرين في تحديد الغرض.",
    ...
    makeAdvertisingDesc: "إعلانات مستهدفة للوصول إلى المزيد من المشاهدات في المنطقة التي فقدت أو وجدت فيها الأغراض",
    ...
    items: "أغراض",
    seeAll: "عرض الكل",
    onlyOneFoundPost: "يوجد منشور واحد فقط للأغراض التي عثر عليها في بلدك. أضف منشوراً آخر لمساعدة الآخرين في العثور على أغراضهم المفقودة.",
    onlyOneLostPost: "يوجد منشور واحد فقط للأغراض المفقودة في بلدك. أضف منشوراً آخر لمساعدة الآخرين في العثور على أغراضهم المفقودة.",
    ...
    contactDescription: "نحن هنا لمساعدتك! سواء كان لديك أسئلة حول منصتنا، أو تحتاج مساعدة مع غرض مفقود أو موجود، أو تريد تقديم ملاحظات، نحب أن نسمع منك.",
    ...
    postReturned: "تم العثور على الغرض",
    ...
    locationData: "الموقع التقريبي المستنتج من عنوان IP الخاص بك، يُستخدم فقط لاقتراح بلدك عند فتح التطبيق لأول مرة (ليس عبر GPS، ولا يتم تخزينه)",
    crashDiagnosticsData: "تقارير الأعطال وبيانات التشخيص عند حدوث خطأ في التطبيق، لمساعدتنا في اكتشاف الأخطاء وإصلاحها",
    howWeUseInformation: "كيفية استخدام المعلومات",
    howWeUseInformationContent: "تساعدنا معلوماتك في تقديم خدمات أفضل وتحسين المنصة.",
    provideServices: "تقديم خدمات فقدان وإيجاد الأغراض",
    ...
    provideAccurateInformation: "تقديم معلومات دقيقة حول الأغراض",
    noFalseClaims: "لا ادعاءات كاذبة حول الأغراض أو الهوية",
    ...
    falseInformationDesc: "تقديم معلومات خاطئة حول الأغراض أو الهوية",
    ...
    meetingSafelyDesc: "عندما تلتقي بشخص لتبادل الأغراض، أولوية سلامتك.",
    ...
    verifyItemDetails: "التحقق من تفاصيل ووصف الغرض",
    ...
    vagueDescriptions: "أوصاف غامضة أو غير متسقة للأغراض",
    refusalToVerify: "رفض التحقق من الهوية أو تفاصيل الغرض",
    ...
    checkItemDescription: "فحص وصف الغرض والصور بعناية",
    ...
    inspectItemCarefully: "فحص الغرض بعناية قبل القبول",
    ...
    updateStatus: "تحديث حالة الغرض على المنصة",
    stayInTouch: "البقاء على اتصال عبر المنصة إذا لزم الأمر",
    frequentlyAskedQuestions: "الأسئلة الشائعة",
    whatIfItemIsDamaged: "ماذا لو كان الغرض تالفاً أو لا يتطابق مع الوصف؟",
    whatIfItemIsDamagedAnswer: "وثق الحالة بالصور واتصل بالدعم فوراً. لا تقبل الأغراض التالفة.",
    ...
    howToVerifyItem: "كيف يمكنني التحقق من أن الغرض أصلي؟",
    howToVerifyItemAnswer: "اطلب صوراً مفصلة، اطلب التحقق والتق في مكان عام لفحص الغرض بدقة.",
    ...
    // About Us page translations
    aboutUs: "من نحن",
    reunitingCommunities: "جمع المجتمعات، غرض واحد في كل مرة",
    ...
    ourMission: "مهمتنا",
    missionDescription: "نؤمن أن كل غرض مفقود له قصة وكل غرض عثر عليه له مالك ينتظر أن يجتمع معه. من خلال منصتنا، نخلق روابط ذات معنى تعيد الأمل وتقوي الروابط المجتمعية.",
    ...
    fastMatchingDesc: "خوارزميات ذكية والتقارير المجتمعية تساعد في مطابقة الأغراض المفقودة والعثر عليها بسرعة.",
    ...
    blogPost1Excerpt: "تعلم كيفية البقاء آمناً عند مقابلة شخص لإرجاع أو المطالبة بغرض مفقود. إرشادات مهمة للتبادلات الآمنة.",
    blogPost1Content: "عند مقابلة شخص لإرجاع أو المطالبة بغرض مفقود، يجب أن تكون السلامة دائماً أولويتك القصوى. إليك نصائح أساسية لضمان التبادلات الآمنة: قابل دائماً في أماكن عامة مع إضاءة جيدة وحركة مرور. أحضر صديقاً أو فرداً من العائلة معك. أخبر شخصاً عن مكان لقائك والوقت المتوقع للعودة. ثق بحدسك - إذا شعرت بشيء غريب، أعد الجدولة أو ألغِ اللقاء. تحقق من تفاصيل الغرض قبل اللقاء لضمان الأصالة. احتفظ بمعلوماتك الشخصية خاصة حتى تتأكد من نوايا الشخص الآخر.",
    ...
    blogPost2Content: "إرشادات مجتمعنا مصممة لتعزيز الثقة والاحترام والسلامة بين جميع المستخدمين. كن صادقاً ودقيقاً في منشوراتك - قدم أوصافاً واضحة وصوراً حقيقية. احترم خصوصية الآخرين ومعلوماتهم الشخصية. استخدم لغة مناسبة وتجنب المحتوى المسيء. أبلغ عن السلوك المشبوه أو غير المناسب فوراً. كن صبوراً ومتفهماً عند التواصل مع مستخدمين آخرين. تذكر أن وراء كل منشور شخص حقيقي قد يكون متوتراً بشأن غرضه المفقود أو متحمساً لمساعدة شخص ما.",
    ...
    blogPost4Excerpt: "تعلم كيفية التقاط صور واضحة ومفيدة تزيد من فرصك في العثور على مالك غرض مفقود.",
    blogPost4Content: "التصوير الجيد أمر بالغ الأهمية لمنشورات البحث عن الأشياء المفقودة الناجحة. استخدم الإضاءة الطبيعية كلما أمكن - الصور الخارجية غالباً ما تكون أوضح من الداخلية. التقط زوايا متعددة للغرض، بما في ذلك اللقطات المقربة لأي ميزات مميزة أو أسماء العلامات التجارية أو الأرقام التسلسلية. أدرج غرضاً شائعاً (مثل عملة معدنية أو قلم) كمرجع للحجم. تأكد من أن الغرض نظيف ومضاء جيداً. تجنب الصور الضبابية أو المظلمة. إذا كان للغرض قيمة عاطفية، كن محترماً في كيفية تصويره. تذكر، الهدف هو مساعدة المالك في التعرف على غرضه بسرعة ودقة.",
    ...
    blogPost6Content: "لقد غيرت التكنولوجيا الحديثة كيفية التعامل مع الأشياء المفقودة والموجودة. تستخدم منصتنا خوارزميات مطابقة متقدمة لربط الأغراض المماثلة مع الملاك المحتملين. تساعد تكامل GPS في تحديد المواقع الدقيقة حيث فُقدت أو وُجدت الأغراض. تساعد تكنولوجيا التعرف على الصور في تحديد الأغراض من الصور. تضمن الإشعارات في الوقت الفعلي ألا يفوت المستخدمون التحديثات المهمة. تسمح التحسينات المحمولة للمستخدمين بالنشر والبحث أثناء التنقل. هذه التطورات التكنولوجية زادت بشكل كبير من معدلات النجاح وقللت الوقت اللازم لإعادة لم شمل الأغراض مع ملاكها.",
    ...
    blogPost8Content: "الوقاية دائماً أفضل من البحث. إليك نصائح عملية لتجنب فقدان ممتلكاتك: تحقق دائماً من مقعدك والمنطقة المحيطة قبل مغادرة أي مكان. استخدم أجهزة التتبع للأغراض القيمة مثل الهواتف والمفاتيح والحقائب. التقط صوراً للوثائق والأغراض المهمة للتعرف السهل. احتفظ بقائمة بأرقام التسلسل للإلكترونيات. استخدم أغلفة أو إكسسوارات مميزة لجعل أغراضك قابلة للتعرف عليها بسهولة. لا تترك أغراضاً دون مراقبة في الأماكن العامة. فكر في نقش أو وضع علامة على الأغراض القيمة بمعلومات الاتصال الخاصة بك. هذه الخطوات البسيطة يمكن أن توفر عليك الوقت والتوتر وبدائل مكلفة محتملة.",
    ...
    blogPost9Content: "الأشياء المفقودة لا تحترم الحدود، ولا يجب أن تحترمها حلولنا أيضاً. تربط منصتنا المستخدمين عبر المغرب والعالم العربي الأوسع، مما يسهل الإرجاعات عبر الحدود. ندعم لغات متعددة لكسر حواجز التواصل. مجتمعنا يشمل المسافرين والمغتربين والمحليين الذين يفهمون تحديات السفر الدولي. نعمل مع السلطات المحلية والسفارات عند الضرورة لتسهيل الإرجاعات. توجه الحساسية الثقافية نهجنا تجاه المجتمعات والتقاليد المختلفة. سواء كنت سائحاً فقد شيئاً أو محلياً وجد غرض مسافر، منصتنا تملأ الفجوة.",
    ...
    blogPost10Content: "يأتي تطبيقنا المحمول بقوة منصتنا إلى أطراف أصابعك. انشر الأشياء المفقودة أو الموجودة فوراً بكاميرا هاتفك. استقبل إشعارات في الوقت الفعلي عندما يرد شخص على منشورك. استخدم GPS لوضع علامة تلقائية على موقعك عند النشر. ابحث في المناطق القريبة مع مرشحاتنا القائمة على الموقع. الوصول إلى تاريخ منشوراتك وإدارة أغراض متعددة بسهولة. شارك المنشورات مباشرة على وسائل التواصل الاجتماعي لزيادة الرؤية. يعمل التطبيق دون اتصال للوظائف الأساسية ويتزامن عندما تعود متصلاً. مع الإشعارات الفورية، لن تفوت أبداً تحديثاً مهماً حول أشياءك المفقودة أو الموجودة.",
    ...
    reportingItems: "الإبلاغ عن الأغراض",
    ...
    faq3Answer: "يمكنك تصفح المنشورات والبحث عن الأغراض بدون حساب، ولكن لإنشاء منشورات جديدة أو التواصل مع المستخدمين الآخرين، ستحتاج إلى إنشاء حساب مجاني.",
    
    faq4Question: "كيف يمكنني الإبلاغ عن غرض مفقود؟",
    faq4Answer: "انقر على زر 'إضافة منشور جديد' في الصفحة الرئيسية، اختر 'مفقود'، ثم املأ النموذج بالمعلومات المطلوبة بما في ذلك الوصف والموقع والصور إن أمكن. كلما كانت المعلومات أكثر تفصيلاً، زادت فرص العثور على غرضك.",
    
    faq5Question: "كيف يمكنني الإبلاغ عن غرض وجدته؟",
    faq5Answer: "انقر على زر 'إضافة منشور جديد'، اختر 'موجود'، ثم املأ النموذج بالتفاصيل. تأكد من وصف الغرض بدقة وتضمين صور واضحة. هذا يساعد أصحاب الأغراض المفقودة على التعرف على ممتلكاتهم.",
    ...
    faq7Question: "كيف أضمن سلامتي عند مقابلة شخص لاسترداد غرض؟",
    ...
    // Help Topics
    howToReportLost: "كيفية الإبلاغ عن غرض مفقود",
    howToReportLostDesc: "تعلم الخطوات التفصيلية للإبلاغ عن غرض مفقود وزيادة فرص العثور عليه.",
    howToReportFound: "كيفية الإبلاغ عن غرض موجود",
    howToReportFoundDesc: "اكتشف كيفية الإبلاغ عن غرض وجدته ومساعدة أصحابه في العثور عليه.",
    safetyGuidelines: "إرشادات السلامة",
    safetyGuidelinesDesc: "نصائح مهمة لضمان سلامتك عند مقابلة أشخاص لاسترداد الأغراض.",
    photoTips: "نصائح التصوير",
    photoTipsDesc: "تعلم كيفية التقاط صور فعالة لزيادة فرص العثور على أغراضك المفقودة.",
    ...
    articleNotFoundDescription: "المقالة التي تبحث عنها غير موجودة أو ربما تم نقلها.",
    safety: "السلامة",
    guidelines: "الإرشادات",
    success: "النجاح",
    tips: "النصائح",
    ...
    pushOfferTitle: "اعرف فور ظهوره",
    pushOfferBody: "نقارن كل إعلان جديد بإعلانك. فعّل التنبيهات ونُعلِمك فور نشر أحدهم غرضًا يشبه هذا الغرض.",
    pushOfferPointMatch: "فقط عند وجود إعلان يشبه إعلانك — بلا أي إعلانات ترويجية.",
    pushOfferPointClosed: "يصلك حتى عندما يكون مفقودات مغلقًا.",
    pushOfferPointOff: "يمكنك إيقافه في أي وقت من إعدادات التنبيهات.",
    pushOfferEnable: "تفعيل التنبيهات",
    pushOfferSkip: "ليس الآن",
    pushOfferFootnote: "في الحالتين، سيُنشر إعلانك مباشرة بعد ذلك.",
    notifPrefPushAlerts: "التنبيهات الفورية",
    notifPrefPushAlertsDescription: "مفتاح عام للتنبيهات المرسلة إلى هاتفك ومتصفحاتك. تنبيهات التطبيق تعمل في الحالتين.",
    notifPrefBrowserAlerts: "تنبيهات المتصفح",
    notifPrefBrowserAlertsDescription: "استقبل التنبيهات على هذا الجهاز حتى عندما يكون مفقودات مغلقًا.",
    notifPrefBrowserAlertsBlocked: "التنبيهات محظورة لهذا الموقع. اسمح بها من إعدادات المتصفح لتفعيل هذا الخيار.",
    notifPrefBrowserAlertsUnsupported: "هذا المتصفح لا يدعم التنبيهات. على آيفون، أضف مفقودات إلى الشاشة الرئيسية أولًا.",
    notifPrefBrowserAlertsEnable: "تفعيل",
    notifPrefBrowserAlertsMuted: "هذا المتصفح مشترك بالفعل، لكن التنبيهات الفورية معطّلة أعلاه، لذا لا يصله شيء.",
