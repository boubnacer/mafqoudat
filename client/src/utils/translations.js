...
export const translations = {
  en: {
    ...
    imageWarningBulletUseNeutralBackground: "Use a neutral background and focus on the general appearance of the item instead of highlighting amounts of cash or unique markings.",
  ...
  fr: {
    ...
    imageWarningBulletUseNeutralBackground: "Utilisez un arrière-plan neutre et concentrez-vous sur l'apparence générale de l'objet plutôt que sur des détails comme les montants d'argent ou les marques uniques.",
  ...
  ar: {
    ...
    imageWarningBulletUseNeutralBackground: "استخدم خلفية محايدة وركّز على المظهر العام للعنصر بدلاً من إبراز مبالغ المال أو العلامات المميزة.",
