...
export const translations = {
  en: {
    ...
    confirmPassword: "Confirm Password",
    createAccount: "Create Account",
    createAccountMessage: "Join our community to help find lost items and return found items",
    rememberMe: "Remember me",
    forgotPassword: "Forgot Password?",
    firstTime: "First time here?",
    alreadyMember: "Already have an account?",
    ...
    createAccountMessage: "Rejoignez notre communauté pour aider à trouver les objets perdus et retourner les objets trouvés",
  ...
  ar: {
    ...
    welcomeMessage: "سجل دخولك للوصول إلى حسابك",
    signin: "تسجيل الدخول",
    signup: "إنشاء حساب",
