...
export const translations = {
  en: {
    ...
    notifMatchHeadlineForLost: "Someone found a {item} that could be yours",
    notifMatchHeadlineForFound: "Someone is looking for a {item} like the one you found",
    notifAgainstYourListing: "Matched with your listing: {item}",
  ...
  fr: {
    ...
    notifMatchHeadlineForLost: "Une annonce d'objet trouvé correspond à la vôtre : {item}",
    notifMatchHeadlineForFound: "Une annonce d'objet perdu correspond à la vôtre : {item}",
    notifAgainstYourListing: "Correspond à votre annonce : {item}",
  ...
  ar: {
    ...
    notifMatchHeadlineForLost: "إعلان عن غرض تم العثور عليه يطابق إعلانك: {item}",
    notifMatchHeadlineForFound: "إعلان عن غرض مفقود يطابق إعلانك: {item}",
    notifAgainstYourListing: "يطابق إعلانك: {item}",
