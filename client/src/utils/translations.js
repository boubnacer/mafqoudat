...
export const translations = {
  en: {
    ...
    imageWarningDescriptionFound: "For found items, please avoid uploading photos that reveal sensitive details such as the exact amount of cash, unique markings, or serial numbers. Keeping these details private helps us confirm the rightful owner.",
    imageWarningDescriptionLost: "For lost items, please upload a clear photo that helps others recognize the item while keeping personal or confidential information hidden.",
    imageWarningBulletProtectDetails: "Protect sensitive details: avoid showing amounts, codes, or personal identifiers.",
  ...
  fr: {
    ...
    imageWarningDescriptionFound: "Pour les objets trouvés, veuillez éviter de télécharger des photos qui révèlent des détails sensibles tels que le montant exact d'argent, des marques uniques ou des numéros de série. Garder ces informations privées nous aide à confirmer le véritable propriétaire.",
    imageWarningDescriptionLost: "Pour les objets perdus, veuillez télécharger une photo claire qui aide les autres à reconnaître l'objet tout en préservant vos informations personnelles ou confidentielles.",
    imageWarningBulletProtectDetails: "Protégez les détails sensibles : ne montrez pas les montants, codes ou identifiants personnels.",
  ...
  ar: {
    ...
    imageWarningDescriptionFound: "بالنسبة للعناصر التي تم العثور عليها، يرجى تجنب تحميل صور تكشف تفاصيل حساسة مثل المبلغ الدقيق من المال أو العلامات الفريدة أو الأرقام التسلسلية. الحفاظ على هذه التفاصيل سرًّا يساعدنا في التأكد من وصول العنصر إلى مالكه الشرعي.",
    imageWarningDescriptionLost: "بالنسبة للعناصر المفقودة، يرجى تحميل صورة واضحة تساعد الآخرين على التعرّف على العنصر مع الحفاظ على معلوماتك الشخصية أو السرية.",
    imageWarningBulletProtectDetails: "احمِ التفاصيل الحساسة: تجنّب إظهار المبالغ أو الرموز أو المعرفات الشخصية.",
