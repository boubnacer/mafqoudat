...
export const translations = {
  en: {
    ...
    communityHelp: "Advanced Filtering",
    communityHelpDesc: "Search by category, city, and location to find exactly what you need",
  ...
  fr: {
    ...
    communityHelp: "Filtrage Avancé",
    communityHelpDesc: "Recherchez par catégorie, ville et emplacement pour trouver exactement ce dont vous avez besoin",
  ...
  ar: {
    ...
    communityHelp: "التصفية المتقدمة",
    communityHelpDesc: "ابحث حسب الفئة والمدينة والموقع للعثور على ما تحتاجه بالضبط",
