...
export const translations = {
  en: {
    ...
    imageWarningDescriptionFound: "Please avoid uploading photos that reveal sensitive details such as the exact amount of cash, unique markings, or serial numbers. Keeping these details private helps us confirm the rightful owner.",
    ...
    imageWarningBulletProtectDetails: "Protect sensitive details: avoid showing amounts, serial numbers, or the contents of a bag.",
  ...
  fr: {
    ...
    imageWarningDescriptionFound: "Veuillez éviter de télécharger des photos révélant des détails sensibles comme le montant exact d'argent, des marques uniques ou des numéros de série. Garder ces informations privées nous aide à confirmer le véritable propriétaire.",
    ...
    imageWarningBulletProtectDetails: "Protégez les détails sensibles : évitez de montrer les montants, les numéros de série ou le contenu d'un sac.",
  ...
  ar: {
    ...
    imageWarningDescriptionFound: "يرجى تجنب تحميل صور تكشف تفاصيل حساسة مثل المبلغ الدقيق من المال أو العلامات الفريدة أو الأرقام التسلسلية. يساعدنا الحفاظ على هذه التفاصيل سرًّا في التأكد من وصول العنصر إلى مالكه الشرعي.",
    ...
    imageWarningBulletProtectDetails: "احمِ التفاصيل الحساسة: تجنّب إظهار المبالغ أو الأرقام التسلسلية أو محتويات الحقيبة.",
