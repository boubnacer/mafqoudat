...
export const translations = {
  en: {
    ...
    documentTitleFieldLabel: "Which document is it?",
    ...
    documentPrivacyNotice: "To protect your identity, listings about documents are published without a photo. The title you pick here identifies the document instead.",
    documentPhotoDisabledTitle: "No photo for documents",
    documentPhotoDisabledMessage: "A photo of an official document shows your name, its number and your address to everyone who opens the listing. That is why this step is skipped: the document title you chose is what identifies it.",
    ...
    documentOwnerSectionTitle: "Name on the document",
    documentOwnerSectionHint: "These listings carry no photo, so the name written on the document is how its owner recognises it. Write it in both scripts, exactly as it appears on the document.",
  ...
  fr: {
    ...
    selectedDocumentTitles: "Document",
    documentTitleFieldLabel: "De quel document s'agit-il ?",
    ...
    documentPrivacyNotice: "Pour protéger votre identité, les annonces concernant des documents sont publiées sans photo. Le titre que vous choisissez ici identifie le document à la place.",
    documentPhotoDisabledTitle: "Pas de photo pour les documents",
    documentPhotoDisabledMessage: "La photo d'un document officiel montre votre nom, son numéro et votre adresse à toute personne qui ouvre l'annonce. C'est pourquoi cette étape est ignorée : le titre du document que vous avez choisi suffit à l'identifier.",
    ...
    documentOwnerSectionTitle: "Nom figurant sur le document",
    documentOwnerSectionHint: "Ces annonces ne comportent aucune photo : le nom inscrit sur le document est donc ce qui permet à son propriétaire de le reconnaître. Écrivez-le dans les deux écritures, exactement comme sur le document.",
  ...
  ar: {
    ...
    optional: "اختياري",
    imageOptionalMessage: "إضافة صورة اختيارية ولكن موصى بها بشدة للمساعدة في تحديد الغرض",
    ...
    documentTitleFieldLabel: "ما هي الوثيقة؟",
    documentTitleFieldHint: "اختر الوثيقة من القائمة. لم تجدها؟ أضفها عبر «وثيقة أخرى» وسيتم حفظها للجميع.",
    documentPrivacyNotice: "حمايةً لهويتك، تُنشر الإعلانات المتعلقة بالوثائق بدون صورة. العنوان الذي تختاره هنا هو ما يعرّف الوثيقة.",
    documentPhotoDisabledTitle: "لا صورة للوثائق",
    documentPhotoDisabledMessage: "صورة وثيقة رسمية تكشف اسمك ورقمها وعنوانك لكل من يفتح الإعلان. لهذا تم تخطي هذه الخطوة: عنوان الوثيقة الذي اخترته يكفي للتعريف بها.",
    ...
    documentOwnerSectionTitle: "الاسم المكتوب على الوثيقة",
    documentOwnerSectionHint: "هذه الإعلانات تُنشر بدون صورة، لذا فإن الاسم المكتوب على الوثيقة هو ما يتعرف به صاحبها عليها. اكتبه بالحرفين معًا، كما هو مدوّن في الوثيقة تمامًا.",
