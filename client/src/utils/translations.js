...
export const translations = {
  en: {
    ...
    otherDocumentHint: "Write the document name in both scripts. It will be added to the list so others can find it too.",
    documentNameArabic: "Name in Arabic",
    documentNameLatin: "Name in Latin letters",
    documentNameArabicPlaceholder: "مثال: بطاقة المكتبة",
    documentNameLatinPlaceholder: "e.g. Library card",
  ...
  fr: {
    ...
    otherDocumentHint: "Écrivez le nom du document dans les deux écritures. Il sera ajouté à la liste pour que d'autres le trouvent aussi.",
    documentNameArabic: "Nom en arabe",
    documentNameLatin: "Nom en lettres latines",
    documentNameArabicPlaceholder: "مثال: بطاقة المكتبة",
    documentNameLatinPlaceholder: "ex. Carte de bibliothèque",
  ...
  ar: {
    ...
    otherDocument: "وثيقة أخرى",
    otherDocumentHint: "اكتب اسم الوثيقة بالحرفين معًا. ستتم إضافته إلى القائمة ليجده غيرك أيضًا.",
    documentNameArabic: "الاسم بالعربية",
    documentNameLatin: "الاسم بالحروف اللاتينية",
    documentNameArabicPlaceholder: "مثال: بطاقة المكتبة",
    documentNameLatinPlaceholder: "مثال: Carte de bibliothèque",
