...
const LogoButton = styled(Button)(({ theme }) => ({
  ...
  '& img': {
    height: 'auto',
    maxHeight: theme.palette.mode === 'dark' ? '28px' : '24px', // Bigger in dark mode
    width: 'auto',
    objectFit: 'contain',
    ...
    ...(theme.palette.mode === 'dark' && {
      ...
      borderRadius: '8px',
      padding: '8px', // Increased padding for larger logo
  ...
  [theme.breakpoints.down('sm')]: {
    ...
    '& img': {
      maxHeight: theme.palette.mode === 'dark' ? '22px' : '18px', // Bigger in dark mode
    }
  }
}));
