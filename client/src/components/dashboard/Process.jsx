  ...
  return (
    ...
    >
      <Box sx={{ position: "relative", zIndex: 1 }}>
        ...
        {/* Capped at md+: the stage is a single fixed 820x916 composition scaled
            to fit whatever width `useHostWidth` measures, and a wide desktop
            panel gives it more than that — rendering the full-size artwork
            and dwarfing the three-sentence copy inside it. Capping the
            *measured* width (not a separate scale knob) keeps it the exact
            same design at a size that reads as one section among others
            rather than a full-bleed banner; xs/sm are already narrower than
            this cap in practice, so mobile is unaffected. */}
        <Box ref={hostRef} sx={{ width: "100%", maxWidth: { xs: "100%", md: 640 }, mx: "auto" }}>
          {renderStage()}
        </Box>
