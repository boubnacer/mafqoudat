        ...
        >
          {!selectedCountryObj
            ? t('selectCountryFirst')
              : getFoundLostType(values.foundLost) === 'LOST'
                ? currentLanguage === 'ar'
                  ? 'يرجى تحديد المدينة التي فقدت فيها الغرض أو أقرب مدينة رئيسية إليها'
                  : currentLanguage === 'fr'
                ...
                : currentLanguage === 'ar'
                  ? 'يرجى تحديد المدينة التي وجدت فيها الغرض أو أقرب مدينة رئيسية إليها'
                  : currentLanguage === 'fr'
        ...
        >
          {getFoundLostType(values.foundLost) === 'LOST'
            ? currentLanguage === 'ar'
              ...
              : currentLanguage === 'fr'
                ? 'Veuillez spécifier l\'emplacement exact et détaillé où vous avez perdu l\'objet (ex: nom du quartier, la rue, le village, près d\'un café nommé...)'
                : 'Please specify the precise and detailed location where you lost the item (e.g., neighborhood name, street, village, near a named cafe...)'
            : currentLanguage === 'ar'
              ? 'يرجى تحديد الموقع الدقيق والتفصيلي حيث وجدت الغرض (مثال: حي النور، شارع الملك، بجانب المسجد، أو أي معلم مميز)'
              : currentLanguage === 'fr'
