  ...
  return (
    <Box
      sx={{
        ...
        bottom: 0,
        // Transparent on all breakpoints so this blends into the Paper's
        // actual rendered surface (MUI layers a subtle elevation overlay on
        // Paper in dark mode, which a flat token color wouldn't pick up),
        // matching desktop's inline treatment even though this bar is
        // sticky on mobile.
