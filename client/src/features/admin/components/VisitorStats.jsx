...
const VisitorStats = () => {
  ...
  const { statistics, trends, visitorCountries } = visitorData.data;
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardContent>
              ...
              <Divider sx={{ mb: 2 }} />
              {visitorCountries && visitorCountries.length > 0 ? (
                <TableContainer>
                  <Table size="small">
                    <TableHead>
                      <TableRow>
                ...
                <Alert severity="info">No country data available</Alert>
              )}
            </CardContent>
          </Card>
        </Grid>
