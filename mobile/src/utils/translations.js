...
export const translations = {
  en: {
    ...
    exactDateFormatExample: "24/07/2026",
    exactDateInvalidFormat: "Please enter a valid date in DD/MM/YYYY format",
    exactDateFutureNotAllowed: "Date cannot be in the future",
  ...
  fr: {
    ...
    exactDateFormatExample: "24/07/2026",
    exactDateInvalidFormat: "Veuillez saisir une date valide au format JJ/MM/AAAA",
    exactDateFutureNotAllowed: "La date ne peut pas être dans le futur",
  ...
  ar: {
    ...
    exactDateFormatExample: "24/07/2026",
    exactDateInvalidFormat: "يرجى إدخال تاريخ صالح بصيغة يوم/شهر/سنة",
    exactDateFutureNotAllowed: "لا يمكن أن يكون التاريخ في المستقبل",
