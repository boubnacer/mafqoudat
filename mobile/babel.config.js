module.exports = function(api) {
  ...
  return {
    ...
    env: {
      ...
      production: {
        // console.error and console.warn are kept: alongside Firebase Crashlytics
        // (src/utils/crashReporting.js) they're the diagnostic signal this app has
        // in the field, and dropping them would trade a real debugging channel for
        // very little - reading another app's logcat needs adb or root, since
