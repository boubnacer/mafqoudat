...
async function fixAllPostsData() {
  try {
    ...
    for (let i = 0; i < posts.length; i++) {
      ...
      // Assign different categories and cities in rotation
      ...
      console.log(`✅ Fixed post ${post._id}: ${category.code} in ${city.code}`);
      fixedCount++;
    }

    console.log(`\n🎉 Fixed ${fixedCount} posts with valid categories and cities`);
...
console.log('🚀 Starting to fix all posts data...');
fixAllPostsData();
